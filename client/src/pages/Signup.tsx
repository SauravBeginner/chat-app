...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center py-2 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <form
          ...
          className="m-8 space-y-6 bg-white/10 backdrop-blur-md p-8 rounded-2xl"
        >
          <Input
            id="fullName"
            name="fullName"
